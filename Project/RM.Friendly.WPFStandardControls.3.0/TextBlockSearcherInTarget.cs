...
namespace RM.Friendly.WPFStandardControls
{
    ...
    /// </summary>
#endif
    public static class TextBlockSearcherInTarget
    {
#if ENG
        /// <summary>
        ...
        static IEnumerable<DependencyObject> ByTextCore(IEnumerable<DependencyObject> collection, string contentText)
        {
            List<DependencyObject> result = new List<DependencyObject>();
            foreach (TextBlock e in collection)
            {
                if (e.Text == contentText)
                {
                    result.Add(e);
                }
            }
