...
namespace RM.Friendly.WPFStandardControls
{
    ...
    public static class TreeUtilityInTargetExtensions
    {
        ...
        /// <returns>列挙されたDependencyObject。</returns>
#endif
        public static IEnumerable<DependencyObject> VisualTreeWithPopup(this DependencyObject start, TreeRunDirection direction = TreeRunDirection.Descendants)
        {
            return TreeUtilityInTarget.VisualTreeWithPopup(start, direction);
        }
