...
namespace RM.Friendly.WPFStandardControls
{
    ...
    /// </summary>
#endif
    public static class ContentControlSearcherInTargetExtensions
    {
#if ENG
        /// <summary>
...
#endif
        public static IEnumerable<T> ByContentText<T>(this IEnumerable<T> collection, string contentText) where T : ContentControl
            => ContentControlSearcherInTarget.ByContentText(collection, contentText);
    }
}